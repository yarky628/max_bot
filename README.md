...
Чат-бот «Право выбора» — цифровой помощник для людей, возвращающихся к нормальной жизни после сложных обстоятельств. Помогает восстановить документы, найти программы поддержки и работу, получить первую психологическую помощь и связаться с профильными НКО.
...
* Не коммить `.env` в публичные репозитории.
* Если токен утек — немедленно его отозвать в панели MAX.
